...
def main():
  ...
  iosv_0.execs([
    [
      f"router ospf {ini.site_a.ospf_process_id} vrf {ini.site_a.name}",
      f"network {ini.iosv_0.g0_0.ip_addr.network.network_address} {ini.iosv_0.g0_0.ip_addr.hostmask} area 0",
      f"network {ini.iosv_0.g0_2.sub0.ip_addr.network.network_address} {ini.iosv_0.g0_2.sub0.ip_addr.hostmask} area 0",
    ],
    [
      f"router ospf {ini.site_b.ospf_process_id} vrf {ini.site_b.name}",
      f"network {ini.iosv_0.g0_1.ip_addr.network.network_address} {ini.iosv_0.g0_1.ip_addr.hostmask} area 0",
      f"network {ini.iosv_0.g0_2.sub1.ip_addr.network.network_address} {ini.iosv_0.g0_2.sub1.ip_addr.hostmask} area 0",
    ]
  ])
  ...
  iosv_1.execs([
    [
      f"router ospf {ini.site_a.ospf_process_id} vrf {ini.site_a.name}",
      f"network {ini.iosv_1.g0_0.ip_addr.network.network_address} {ini.iosv_1.g0_0.ip_addr.hostmask} area 0",
      f"network {ini.iosv_1.g0_2.sub0.ip_addr.network.network_address} {ini.iosv_1.g0_2.sub0.ip_addr.hostmask} area 0",
    ],
    [
      f"router ospf {ini.site_b.ospf_process_id} vrf {ini.site_b.name}",
      f"network {ini.iosv_1.g0_1.ip_addr.network.network_address} {ini.iosv_1.g0_1.ip_addr.hostmask} area 0",
      f"network {ini.iosv_1.g0_2.sub1.ip_addr.network.network_address} {ini.iosv_1.g0_2.sub1.ip_addr.hostmask} area 0",
    ]
  ])

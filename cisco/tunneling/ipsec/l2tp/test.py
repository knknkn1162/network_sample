...
def main():
  ...
  iosv_0.execs([
    [
      f"pseudowire-class {ini.pw_label}",
      f"encapsulation l2tpv3",
      f"ip local interface {ini.iosv_0.g0_0.name}"
    ],
    [
      f"interface {ini.iosv_0.g0_1.name}",
      # set destination
      f"xconnect {ini.iosv_2.g0_0.ip_addr.ip} {ini.vc_id} encapsulation l2tpv3 pw-class {ini.pw_label}",
    ],
  ])
  ...
  iosv_2.execs([
    ...
    [
      f"interface {ini.iosv_2.g0_1.name}",
      # set destination
      f"xconnect {ini.iosv_0.g0_0.ip_addr.ip} {ini.vc_id} encapsulation l2tpv3 pw-class {ini.pw_label}",
    ],
  ])
  ...
  iosv_0.execs([
    ...
    [
      ...
      f"access-list {ini.ipsec.phase2.acl_num} permit {ini.l2tp_protocol_num} any any",
      # mapping

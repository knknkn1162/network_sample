...
iosv_0.execs([
  [
    ...
    f"neighbor {ini.iosv_1.loopback0.ip_addr} remote-as {ini.iosv_1.loopback0.as_num}",
    f"neighbor {ini.iosv_1.loopback0.ip_addr} update-source {ini.iosv_1.loopback0.name}",
    f"neighbor {ini.iosv_1.loopback0.ip_addr} ebgp-multihop 2",
  ],
  # use static route to connect via ping
  [
    f"ip route {ini.iosv_1.loopback0.ip_addr} {ini.iosv_1.loopback0.subnet_mask} {ini.iosv_1.g0_0.ip_addr}",
  ],
])
...
iosv_1.execs([
  [
    f"router bgp {ini.bgp_num}",
    f"neighbor {ini.iosv_0.loopback0.ip_addr} remote-as {ini.iosv_0.loopback0.as_num}",
    f"neighbor {ini.iosv_0.loopback0.ip_addr} update-source {ini.iosv_1.loopback0.name}",
    f"neighbor {ini.iosv_0.loopback0.ip_addr} ebgp-multihop 2",
  ],
  # use static route to connect via ping
  [
    f"ip route {ini.iosv_0.loopback0.ip_addr} {ini.iosv_0.loopback0.subnet_mask} {ini.iosv_0.g0_0.ip_addr}",
  ],
])

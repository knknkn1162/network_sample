...
r1 = lab.create_node(ini.iosv_1.__name__, "iosv", 400, 300)
r1.config = f"hostname {ini.iosv_1.__name__}"
r2 = lab.create_node(ini.iosv_2.__name__, "iosv", 700, 300)
r2.config = f"hostname {ini.iosv_2.__name__}"
r3 = lab.create_node(ini.iosv_3.__name__, "iosv", 1000, 300)

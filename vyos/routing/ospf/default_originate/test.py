...
def main():
  ...
  pc2.execs([
    f"ip {ini.pc2.eth0.ip_addr.ip} {ini.pc2.eth0.ip_addr.netmask} {ini.vyos2.eth1.ip_addr.ip}",
    f"show",
  ])
  ...
  vyos1.vyos_execs([
    [
      f"set protocols static route 0.0.0.0/0 next-hop {ini.vyos0.eth0.ip_addr.ip}",
      f"set protocols ospf default-information originate",
  ...
  pc2.vpcs_ping(ini.pc1.eth0.ip_addr.ip)

...
def main():
  ...
  vyos0.vyos_execs([
    [
      ...
      f"set interfaces bridge br0 member interface eth2 native-vlan {ini.vyos0.br0.eth2.vlan_num}",
      f"set interfaces bridge br0 member interface eth3 native-vlan {ini.vyos0.br0.eth3.vlan_num}",
    ],
  ])

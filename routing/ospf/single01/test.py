...
iosv_1.execs([
  [
    f"router ospf {ini.ospf_process_id}",
    f"network {iosv_1_g0_0_network0} {ini.INVERSE_MASK_24} area {area_id}",
    f"network {iosv_1_g0_1_network0} {ini.INVERSE_MASK_24} area {area_id}",
  ],
])
...
iosv_2.execs([
  [
    f"router ospf {ini.ospf_process_id}",
    f"network {iosv_2_g0_0_network0} {ini.INVERSE_MASK_24} area {area_id}",
    f"network {iosv_2_g0_1_network0} {ini.INVERSE_MASK_24} area {area_id}",
  ],
])
